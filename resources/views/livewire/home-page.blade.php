				...
				<div class="dis-none panel-filter w-full p-t-10">
                    <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                        <div class="filter-col1 p-r-15 p-b-27">
                            ...
                            <ul>
                                <a href="/produtos?selected_marca[0]={{ $marca->id }}" wire:navigate>
                        ...
                        <div class="filter-col2 p-r-15 p-b-27">
                            ...
                            <ul>
                                <li class="p-b-6">
                                    <a href="/produtos?selected_destaques[0]" wire:navigate>
                                ...
                                <li class="p-b-6">
                                    <a href="/produtos?selected_estoque[0]" wire:navigate>
                                    <input type="checkbox" name="" value="1">
                                    Em estoque
                                    </input>
                                    </a>
                                ...
                                <li class="p-b-6">
                                    <a href="/produtos?selected_venda[0]" wire:navigate>
                                        <input type="checkbox" name="" id="a_venda" value="1">
                                        A Venda
                                        </input>
                                    </a>
                                </li>
                        ...
                        <div class="filter-col3 p-r-15 p-b-27">
                            ...
                            <ul>
                                <a href="/produtos?selected_categoria[0]={{ $categoria->id }}" wire:navigate>
                                <li class="p-b-6" style="display: inline-block; margin-right: 15px;">
                                    <input type="checkbox" style="vertical-align: middle;">
